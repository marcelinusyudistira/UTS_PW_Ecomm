      ...
      <div class="modal-body">
        <form action="partials/handleSignup.php" method="post">
          ...
          <div class="text-left my-2">
              ...
              <input class="form-control" id="cpassword" name="cpassword" placeholder="Enter Password" type="password" required data-toggle="password" minlength="4" maxlength="21">
          </div>
          <button type="submit" class="btn btn-success">Submit</button>
        </form>
        <p class="mb-0 mt-1">Sudah memiliki Akun? <a href="#" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#loginModal">Login disini</a>.</p>
      </div>
    </div>
  </div>
</div>
